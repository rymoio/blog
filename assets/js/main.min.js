 ...
 *    <__.|_|-|_|
 *
 *    A blog written by Ryan Morrissey
 *
 *    @version : 1.0.0
 *    @author  : Ryan Morrissey <author@blog.rymo.io>
 *    @license : GNU GPL v2.0
 *    @link    : https://github.com/rymoio/blog
 *
 * ************************************************** !*/
...
!function(){ZeroClipboard.config({swfPath:"/assets/swf/ZeroClipboard.swf"})}(),function(){window.addEventListener("load",function(){window.applicationCache.addEventListener("updateready",function(){window.applicationCache.status==window.applicationCache.UPDATEREADY&&confirm("A new version of this site is available. Load it?")&&window.location.reload()},!1)},!1)}(),function(){$(window).scroll(function(){$(this).scrollTop()>200?$(".scrollToTop").fadeIn():$(".scrollToTop").fadeOut()}),$(".scrollToTop").click(function(){return $("html, body").animate({scrollTop:0},800),!1})}();